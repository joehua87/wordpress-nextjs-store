...
/** Allowed Content Types of the Gender taxonomy. */
...
/** Input for the createGender mutation */
export type CreateGenderInput = {
  /** The slug that the gender will be an alias of */
  aliasOf?: Maybe<Scalars['String']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The description of the gender object */
  description?: Maybe<Scalars['String']>;
  /** The name of the gender object to mutate */
  name: Scalars['String'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: Maybe<Scalars['String']>;
};
...
/** Input for the createRealProject mutation */
...
/** The payload for the createRealProject mutation */
...
/** Input for the deleteGender mutation */
...
/** Input for the deleteRealProject mutation */
export type DeleteRealProjectInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: Maybe<Scalars['Boolean']>;
  /** The ID of the RealProject to delete */
  id: Scalars['ID'];
};

/** The payload for the deleteRealProject mutation */
...
export type ExternalProduct = Node & Product & NodeWithComments & NodeWithContentEditor & NodeWithFeaturedImage & ContentNode & UniformResourceIdentifiable & DatabaseIdentifier & {
  ...
  /** Connection between the Product type and the Gender type */
...
export type Gender = Node & TermNode & UniformResourceIdentifiable & DatabaseIdentifier & MenuItemLinkable & {
  ...
  /** Connection between the Gender type and the ContentNode type */
  ...
  /** The human friendly name of the object. */
  name?: Maybe<Scalars['String']>;
  /** The Yoast SEO data of the Genders taxonomy. */
  seo?: Maybe<TaxonomySeo>;
  /** An alphanumeric identifier for the object unique to its type. */
  slug?: Maybe<Scalars['String']>;
  /** Connection between the Gender type and the Taxonomy type */
...
export type GenderToContentNodeConnection = {
  ...
  /** Edges for the GenderToContentNodeConnection connection */
...
/** Arguments for filtering the GenderToContentNodeConnection connection */
...
export type ProductToGenderConnection = {
  ...
  /** Edges for the ProductToGenderConnection connection */
...
export type ProductToGenderConnectionEdge = {
  ...
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The Yoast SEO Primary gender */
  isPrimary?: Maybe<Scalars['Boolean']>;
  /** The item at the end of the edge */
  node?: Maybe<Gender>;
};

/** Arguments for filtering the ProductToGenderConnection connection */
...
export type RealProject = Node & ContentNode & UniformResourceIdentifiable & DatabaseIdentifier & NodeWithTemplate & NodeWithTitle & NodeWithContentEditor & NodeWithFeaturedImage & MenuItemLinkable & {
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']>;
  /** The globally unique identifier of the real-project object. */
  id: Scalars['ID'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean'];
  /** Whether the object is a node in the preview state */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']>;
  /** Connection between the RealProject type and the RealProject type */
  preview?: Maybe<RealProjectToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Real Project Fields&quot; was set to Show in GraphQL. */
  realProjectFields?: Maybe<RealProject_Realprojectfields>;
  /** The Yoast SEO data of the RealProject */
  seo?: Maybe<PostTypeSeo>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']>;
  /** The current status of the object */
...
export type RootMutation = {
  ...
  /** The payload for the UpdateGender mutation */
  ...
  /** The payload for the updateRealProject mutation */
...
export type RootQuery = {
  ...
  /** A 0bject */
  gender?: Maybe<Gender>;
  /** Connection between the RootQuery type and the Gender type */
  ...
  /** An object of the RealProject Type.  */
  realProject?: Maybe<RealProject>;
  /**
   * A RealProject object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  realProjectBy?: Maybe<RealProject>;
  /** Connection between the RootQuery type and the RealProject type */
...
export type RootQueryToGenderConnection = {
  ...
  /** Edges for the RootQueryToGenderConnection connection */
...
/** Arguments for filtering the RootQueryToGenderConnection connection */
...
export type RootQueryToRealProjectConnection = {
  ...
  /** Edges for the RootQueryToRealProjectConnection connection */
...
/** Arguments for filtering the RootQueryToRealProjectConnection connection */
...
/** Input for the UpdateGender mutation */
export type UpdateGenderInput = {
  ...
  /** The description of the gender object */
  description?: Maybe<Scalars['String']>;
  /** The ID of the Gender object to update */
  id: Scalars['ID'];
  /** The name of the gender object to mutate */
  name?: Maybe<Scalars['String']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
/** Input for the updateRealProject mutation */
export type UpdateRealProjectInput = {
  ...
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: Maybe<Scalars['String']>;
  /** The ID of the RealProject object */
  id: Scalars['ID'];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: Maybe<Scalars['Int']>;
  /** The password used to protect the content of the object */
